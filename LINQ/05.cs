namespace wpf02
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var male = from student in dataContext.Students
                       join university in dataContext.Universities
                       on student.University equals university 
                       where student.Gender == "male"
                       select university;
            MainDataGrid.ItemsSource = male;
        }
        public void GetAllLectures()
        {
            var lectures = from l in dataContext.StudentLectures
                           join student in dataContext.Students on l.StudentId equals student.Id
                           where student.University.Name == "Yale"
                           select l.Lecture;
        ...
        {
            Student tom = dataContext.Students.FirstOrDefault(s => s.Name.Equals("Tom"));
            tom.Name = "Antonio";
            dataContext.SubmitChanges();
            MainDataGrid.ItemsSource = dataContext.Students;
        }
        ...
        {
            Student carl = dataContext.Students.FirstOrDefault(s => s.Name.Equals("Carl"));
            dataContext.Students.DeleteOnSubmit(carl);
            dataContext.SubmitChanges();
            MainDataGrid.ItemsSource = dataContext.Students;
        }
    }
